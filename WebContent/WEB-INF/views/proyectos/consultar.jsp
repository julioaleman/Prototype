	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>
					Registrar Avances <small>Proyectos de Inversión</small>
				</h1>
				<ol class="breadcrumb">
								...
								<div class="board">
									...
									<div class="tab-content">
										...
										<div class="tab-pane fade" id="settings">
											<div class="row">
					                        	<div class="col-md-12">
													...
													<p class="help-block">
														<i class="icon fa fa-info-circle"></i> Puede cargar 3 fotografías con un máximo de 100Kb cada una.
													</p>
												</div>
										...
										<div class="tab-pane fade" id="doner">
											<h3>¡Avance Registrado!</h3>
					                        <p>Sigue registrando avances para que puedar completar el proyecto a tiempo.</p>
					                        <div class="box">
											  	<div class="box-body">
											    	<div class="info-box bg-green">
										                ...
										                <div class="info-box-content">
										                	...
										                	<span class="progress-description">70% del avance</span>
